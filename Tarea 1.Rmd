...
frx <- group_by(atdeport5, Sex)
gfrx <- summarize(frx, Weight=mean(Weight))
barplot(cbind(gfrx$Sexo,gfrx$Weight), main = "Peso Medio Según Peso 5 Deportes Principales", 
        ylab = "Peso Medio", col = c("pink", "blue"))
legend(x = "topright", legend = c("Fem", "Masc"), fill = c("royalblue", "grey"), 
       title = "Gender")
